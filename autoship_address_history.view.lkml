view: autoship_address_history {
  sql_table_name: dbo.AutoshipAddressHistory ;;

  dimension: autoship_address_history_id {
    primary_key: yes
    type: number
    sql: ${TABLE}.AutoshipAddressHistoryId ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [autoship_address_history_id, autoship_address.autoship_address_id, members.member_id, members.username]
  }
}
