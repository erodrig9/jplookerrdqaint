view: order_address_history {
  sql_table_name: dbo.OrderAddressHistory ;;

  dimension: order_address_history_id {
    primary_key: yes
    type: number
    sql: ${TABLE}.OrderAddressHistoryId ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [order_address_history_id, order_address.order_address_id, order_header.autoship_order_header_id]
  }
}
